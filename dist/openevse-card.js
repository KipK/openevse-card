 ...
 */const he=r`
    ...
    .divert-button[data-option="eco"] ha-icon {
        --mdc-icon-size: 22px;
        color: var(--primary-text-color);
        --icon-normal: "mdi:solar-panel";
        --icon-hover: "mdi:lightning-bolt";
    }
    ...
    .divert-button[data-option="fast"] ha-icon {
        --mdc-icon-size: 22px;
        color: var(--evse-auto-color);
        --icon-hover: "mdi:solar-panel";
        --icon-normal: "mdi:lightning-bolt";
    }
                    ...
                    <div class="override-container">
                        ...
                        ${h&&d?W`
                            ...
                            <div class="divert-button"
                                ...
                                <ha-icon
                                    class="divert-icon"
                                    icon=${"eco"==d.state?"mdi:solar-panel":"mdi:transmission-tower-export"}
                                ></ha-icon>
                            </div>
                        `:D}
                    </div>
