    ...
    `,ft([ct({type:Number})],yt.prototype,"min",void 0),ft([ct({type:Number})],yt.prototype,"max",void 0),ft([ct({type:Number})],yt.prototype,"step",void 0),ft([ct({type:Number})],yt.prototype,"value",void 0),ft([ct({type:String})],yt.prototype,"unit",void 0),ft([ct({type:Boolean,reflect:!0})],yt.prototype,"disabled",void 0),ft([ct({type:String})],yt.prototype,"label",void 0),yt=ft([rt("evse-slider")],yt);var bt=function(t,e,i,s){for(var n,r=arguments.length,o=r<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s,a=t.length-1;a>=0;a--)(n=t[a])&&(o=(r<3?n(o):r>3?n(e,i,o):n(e,i))||o);return r>3&&o&&Object.defineProperty(e,i,o),o};let _t=class extends st{constructor(){super(),this.feat_soc=!1,this.feat_range=!1,this.energy_max_value=100,this.range_max_value=600,this.range_unit="km",this.language="en",this._showLimitForm=!1,this._selectedLimitType="time",this._hours=void 0,this._minutes=void 0,this._value=0}static get styles(){return r`
        ...
        `}};jt([ct({attribute:!1})],zt.prototype,"config",void 0),jt([ct({attribute:!1})],zt.prototype,"overrideEntity",void 0),jt([ct({attribute:!1})],zt.prototype,"chargingStatusEntity",void 0),jt([ct({attribute:!1})],zt.prototype,"selectOverrideStateHandler",void 0),zt=jt([rt("override-controls")],zt);var Tt=function(t,e,i,s){for(var n,r=arguments.length,o=r<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s,a=t.length-1;a>=0;a--)(n=t[a])&&(o=(r<3?n(o):r>3?n(e,i,o):n(e,i))||o);return r>3&&o&&Object.defineProperty(e,i,o),o};let Lt=class extends st{constructor(){super(...arguments),this.entities=[]}static get styles(){return ht}_handleEntityClick(t){this.showMoreInfoHandler&&t&&this.showMoreInfoHandler(t)}render(){return this.hass&&this.entities&&0!==this.entities.length?W`
            ${this.entities.map((t=>W`
                ...
                `))}
        `:W``}};Tt([ct({attribute:!1})],Lt.prototype,"hass",void 0),Tt([ct({attribute:!1})],Lt.prototype,"entities",void 0),Tt([ct({attribute:!1})],Lt.prototype,"showMoreInfoHandler",void 0),Lt=Tt([rt("optional-entities")],Lt);var Vt=function(t,e,i,s){for(var n,r=arguments.length,o=r<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s,a=t.length-1;a>=0;a--)(n=t[a])&&(o=(r<3?n(o):r>3?n(e,i,o):n(e,i))||o);return r>3&&o&&Object.defineProperty(e,i,o),o};class Pt extends st{constructor(){super(...arguments),this.state1Value="off",this.state2Value="on",this.currentState=this.state1Value,this.iconState1="mdi:toggle-switch-off-outline",this.colorState1="var(--primary-text-color)",this.iconState2="mdi:toggle-switch",this.colorState2="var(--primary-color)",this.titleState1="State 1",this.titleState2="State 2",this.width=20,this._isHovering=!1}_handleClick(){const t=this.currentState===this.state1Value?this.state2Value:this.state1Value;this.clickHandler&&this.clickHandler(t)}_handleMouseOver(){this._isHovering=!0}_handleMouseOut(){this._isHovering=!1}connectedCallback(){super.connectedCallback(),this.addEventListener("mouseover",this._handleMouseOver),this.addEventListener("mouseout",this._handleMouseOut)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("mouseover",this._handleMouseOver),this.removeEventListener("mouseout",this._handleMouseOut)}render(){const t=this.currentState===this.state1Value,e=(this._isHovering?!t:t)?this.iconState1:this.iconState2,i=t?this.titleState1:this.titleState2,s=t?this.colorState1:this.colorState2,n=t?this.colorState2:this.colorState1,r=.7*this.width;return W`
            <style>
                ...
                <div class="card-content">
                    ...
                    <div class="override-container">
                        ...
                        <toggle-button
                            ...
                            .titleState1=${ut("eco",this._lang)}
                            .titleState2=${ut("fast",this._lang)}
                            .width=${25}
