              ...
              <div class="entity-row">
                ...
                <div class="entity-info">
                  ${t.entity?Pe`
                        ...
                        ></ha-entity-picker>
                        ${t.name||t.icon?Pe`<span class="secondary">(${t.name?`${this.hass.localize("ui.common.name")}: ${t.name}`:""}${t.name&&t.icon?", ":""}${t.icon?`${this.hass.localize("ui.panel.lovelace.editor.card.generic.icon")}: ${t.icon}`:""})</span>`:""}
                      `:Pe`
