...
.titleState2=${ut("switch to eco mode",this._lang)}
        ...
        `}}Nt([ct({attribute:!1})],It.prototype,"hass",void 0),Nt([ct({attribute:!1})],It.prototype,"config",void 0),Nt([lt()],It.prototype,"_lang",void 0),Nt([lt()],It.prototype,"_localTimeElapsed",void 0),Nt([lt()],It.prototype,"_lastEntityTime",void 0),Nt([lt()],It.prototype,"_timeUpdateInterval",void 0),Nt([lt()],It.prototype,"_isCharging",void 0),Nt([lt()],It.prototype,"_limit",void 0),Nt([lt()],It.prototype,"_hasLimit",void 0),Nt([lt()],It.prototype,"_integrationVersionOk",void 0);var Ut=Number.isNaN||function(t){return"number"==typeof t&&t!=t};function Wt(t,e){if(t.length!==e.length)return!1;for(var i=0;i<t.length;i++)if(s=t[i],n=e[i],!(s===n||Ut(s)&&Ut(n)))return!1;var s,n;return!0}function Rt(t,e){void 0===e&&(e=Wt);var i=null;function s(){for(var s=[],n=0;n<arguments.length;n++)s[n]=arguments[n];if(i&&i.lastThis===this&&e(s,i.lastArgs))return i.lastResult;var r=t.apply(this,s);return i={lastResult:r,lastArgs:s,lastThis:this},r}return s.clear=function(){i=null},s}function qt(t,e,i,s,n,r={},o="en"){return{name:t,selector:{entity:{domain:e,include_entities:(Array.isArray(e)?e:[e]).flatMap((t=>r[t]||[]))}},label:ut(i,o),helper_text:ut(s,o),required:n}}const Dt=Rt(((t={},e="en")=>[...[{type:"grid",name:"",schema:[{name:"name",selector:{text:{}},required:!1,label:ut("header title",e)},{name:"header",selector:{boolean:{}},label:ut("display header",e)}]},{type:"grid",name:"",label:ut("features",e),schema:[{name:"feat_soc",selector:{boolean:{}},label:ut("enable vehicle battery",e)},{name:"feat_range",selector:{boolean:{}},label:ut("enable vehicle range",e)}]},{type:"grid",name:"",label:ut("limits settings",e),schema:[{name:"feat_max_energy",selector:{number:{}},required:!1,label:ut("maximum charge energy",e)},{name:"feat_max_range",selector:{number:{}},required:!1,label:ut("maximum vehicle range",e)}]},{name:"device_id",selector:{device:{integration:"openevse",manufacturer:"OpenEVSE"}},label:ut("openevse device",e),helper_text:ut("select your openevse device",e),required:!0}],...[qt("override_entity",["input_select","select"],"override state","select openevse.override_state entity",!0,t,e),qt("status_entity","sensor","station status","select openevse.station_status entity",!0,t,e),qt("power_entity","sensor","current power usage","select openevse.current_power_usage entity",!0,t,e),qt("current_entity","sensor","charging current","select openevse.charging_current entity",!0,t,e),qt("vehicle_connected_entity","binary_sensor","vehicle connected","select openevse.vehicle_connected entity",!0,t,e),qt("charging_status_entity","sensor","charging status","select openevse.charging_status entity",!0,t,e),qt("charge_rate_entity","number","charge rate","select openevse.charge_rate entity",!0,t,e),qt("session_energy_entity","sensor","session energy","select openevse.usage_this_session entity",!0,t,e),qt("time_elapsed_entity","sensor","charge time elapsed","select openevse.charge_time_elapsed entity",!0,t,e),qt("wifi_signal_strength_entity","sensor","wifi signal","select openevse_wifi_signal_strength entity",!1,t,e),qt("limit_active_entity","binary_sensor","limit active","select openevse_limit_active entity",!1,t,e),qt("divert_active_entity","binary_sensor","divert active","select openevse_divert_active entity",!1,t,e),qt("divert_mode_entity","select","divert mode","select openevse_divert_mode",!1,t,e),qt("pv_charge_rate_entity","sensor","Divert pv charge rate","select openevse_pv_charge_rate entity",!1,t,e),qt("vehicle_range_entity","sensor","vehicle range","select openevse_vehicle_range entity",!1,t,e),qt("vehicle_battery_level_entity","sensor","battery level","select openevse_vehicle_battery_level entity",!1,t,e)]]));Rt(((t={},e="en")=>[{name:"id",selector:{entity:{domain:["sensor","binary_sensor"],include_entities:[...t.sensor||[],...t.binary_sensor||[]]}},label:ut("entity",e)},{name:"name",selector:{text:{}},label:ut("name",e)},{name:"icon",selector:{icon:{}},label:ut("icon",e)}]));
/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
