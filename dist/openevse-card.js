    ...
    `,ft([ct({type:Number})],yt.prototype,"min",void 0),ft([ct({type:Number})],yt.prototype,"max",void 0),ft([ct({type:Number})],yt.prototype,"step",void 0),ft([ct({type:Number})],yt.prototype,"value",void 0),ft([ct({type:String})],yt.prototype,"unit",void 0),ft([ct({type:Boolean,reflect:!0})],yt.prototype,"disabled",void 0),ft([ct({type:String})],yt.prototype,"label",void 0),yt=ft([rt("evse-slider")],yt);var bt=function(t,e,i,s){for(var n,r=arguments.length,o=r<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s,a=t.length-1;a>=0;a--)(n=t[a])&&(o=(r<3?n(o):r>3?n(e,i,o):n(e,i))||o);return r>3&&o&&Object.defineProperty(e,i,o),o};let _t=class extends st{constructor(){super(),this.feat_soc=!1,this.feat_range=!1,this.energy_max_value=100,this.range_max_value=600,this.range_unit="km",this.language="en",this.evse_elapsed=0,this.evse_energy=0,this.evse_soc=0,this.evse_range=0,this._showLimitForm=!1,this._selectedLimitType="time",this._hours=void 0,this._minutes=void 0,this._value=0}static get styles(){return r`
        ...
        `}};wt([ct({type:String})],xt.prototype,"label",void 0),wt([ct({type:Number})],xt.prototype,"value",void 0),wt([ct({type:String})],xt.prototype,"unit",void 0),wt([ct({type:Number})],xt.prototype,"max_value",void 0),wt([ct({type:String})],xt.prototype,"icon",void 0),xt=wt([rt("progress-bar")],xt);var $t=function(t,e,i,s){for(var n,r=arguments.length,o=r<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s,a=t.length-1;a>=0;a--)(n=t[a])&&(o=(r<3?n(o):r>3?n(e,i,o):n(e,i))||o);return r>3&&o&&Object.defineProperty(e,i,o),o};let St=class extends st{constructor(){super(),this._isError=!1}static get styles(){return ht}_wifiIcon(t){return t>=-65?"mdi:wifi-strength-4":-65>t&&t>=-70?"mdi:wifi-strength-3":-70>t&&t>=-75?"mdi:wifi-strength-2":-75>t&&t>=-80?"mdi:wifi-strength-1":"mdi:wifi-strength-alert-outline"}render(){if(!this.hass||!this.config)return R``;const t=Number(this.wifiSignalEntity?.state),e=this.statusEntity?.state,i=this.vehicleConnectedEntity?.state,s=this.chargingStatusEntity?.state;return this._isError="vent_required"===s||"diode check failed"===s||"gfci fault"===s||"no ground"===s||"stuck relay"===s||"gfci self-test failure"===s||"over temperature"===s,R`
            <div class="status-icons">
                ...
                <div
                    class="status-icon clickable"
                    @click=${()=>this.showMoreInfoHandler?.(this.config?.status_entity||"")||q}
                >
                    <ha-icon
                        icon="
                            ${this._isError?"mdi:alert-circle":"active"===e?"off"===i?"mdi:timer-sand":"mdi:lightning-bolt":"mdi:cancel"}"
                        class="
                            ${this._isError?"error":"active"===e?"charging"===s?"charging":"active bg-active":"disabled bg-disabled"}"
                    ></ha-icon>
                </div>

                <div
                    class="status-icon clickable"
                    @click=${()=>this.showMoreInfoHandler?.(this.config?.vehicle_connected_entity||"")||q}
                >
                    <ha-icon
        ...
        `}};$t([ct({attribute:!1})],St.prototype,"hass",void 0),$t([ct({attribute:!1})],St.prototype,"config",void 0),$t([ct({attribute:!1})],St.prototype,"wifiSignalEntity",void 0),$t([ct({attribute:!1})],St.prototype,"statusEntity",void 0),$t([ct({attribute:!1})],St.prototype,"vehicleConnectedEntity",void 0),$t([ct({attribute:!1})],St.prototype,"chargingStatusEntity",void 0),$t([ct({attribute:!1})],St.prototype,"showMoreInfoHandler",void 0),$t([lt()],St.prototype,"_isError",void 0),St=$t([rt("status-icons")],St);var Et=function(t,e,i,s){for(var n,r=arguments.length,o=r<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s,a=t.length-1;a>=0;a--)(n=t[a])&&(o=(r<3?n(o):r>3?n(e,i,o):n(e,i))||o);return r>3&&o&&Object.defineProperty(e,i,o),o};let kt=class extends st{constructor(){super(...arguments),this._isError=!1}static get styles(){return ht}render(){const t=this.chargingStatusEntity?.state,e=this.statusEntity?.state;this._isError="vent_required"===t||"diode check failed"===t||"gfci fault"===t||"no ground"===t||"stuck relay"===t||"gfci self-test failure"===t||"over temperature"===t;const i=this._isError?"badge-error":"disabled"===e?"badge-disabled":"charging"===t?"badge-charging":"badge-active";return R`
            <div class="status-badge ${i}">
                ${ut(t||"",this.language)}
            </div>
        `}};Et([ct({attribute:!1})],kt.prototype,"statusEntity",void 0),Et([ct({attribute:!1})],kt.prototype,"chargingStatusEntity",void 0),Et([ct({attribute:!1})],kt.prototype,"language",void 0),Et([lt()],kt.prototype,"_isError",void 0),kt=Et([rt("status-heading")],kt);var Ct=function(t,e,i,s){for(var n,r=arguments.length,o=r<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s,a=t.length-1;a>=0;a--)(n=t[a])&&(o=(r<3?n(o):r>3?n(e,i,o):n(e,i))||o);return r>3&&o&&Object.defineProperty(e,i,o),o};let At=class extends st{constructor(){super(),this.localTimeElapsed=0}static get styles(){return ht}render(){return this.hass&&this.config&&this.convertTimeHandler?R`
            <div class="grid-container">
                ${this.powerEntity?R`
                          <div class="grid-item clickable"
                           @click=${()=>this.showMoreInfoHandler?.(this.config?.power_entity)||q}
                           >
                ...
                ${this.currentEntity?R`
                          <div class="grid-item clickable"
                          @click=${()=>this.showMoreInfoHandler?.(this.config?.current_entity)||q}
                          >
                              <div class="grid-item-label">
                ...
                ${this.sessionEnergyEntity?R`
                              <div class="grid-item clickable"
                               @click=${()=>this.showMoreInfoHandler?.(this.config?.session_energy_entity)||q}
                              >
                                  <div class="grid-item-label">
            ...
            <div class="vehicle">
                ${t?R`
                          <progress-bar
                              ...
                              @click=${()=>this.showMoreInfoHandler?.(this.config?.vehicle_battery_level_entity||"")||q}
                          ></progress-bar> 
                      `:""}
                ${e?R`
                          <progress-bar
                              ...
                              @click=${()=>this.showMoreInfoHandler?.(this.config?.vehicle_range_entity||"")||q}
                          ></progress-bar>
                      `:""}
            </div>
