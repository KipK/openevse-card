 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const le={attribute:!0,type:String,converter:_,reflect:!1,hasChanged:b},he=(e=le,t,i)=>{const{kind:s,metadata:n}=i;let r=globalThis.litPropertyMetadata.get(n);if(void 0===r&&globalThis.litPropertyMetadata.set(n,r=new Map),r.set(i.name,e),"accessor"===s){const{name:s}=i;return{set(i){const n=t.get.call(this);t.set.call(this,i),this.requestUpdate(s,n,e)},init(t){return void 0!==t&&this.P(s,void 0,e),t}}}if("setter"===s){const{name:s}=i;return function(i){const n=this[s];t.call(this,i),this.requestUpdate(s,n,e)}}throw Error("Unsupported decorator location: "+s)};
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function de(e){return(t,i)=>"object"==typeof i?he(e,t,i):((e,t,i)=>{const s=t.hasOwnProperty(i);return t.constructor.createProperty(i,s?{...e,wrapped:!0}:e),s?Object.getOwnPropertyDescriptor(t,i):void 0})(e,t,i)
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */var ve=function(e,t,i,s){for(var n,r=arguments.length,a=r<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s,o=e.length-1;o>=0;o--)(n=e[o])&&(a=(r<3?n(a):r>3?n(t,i,a):n(t,i))||a);return r>3&&a&&Object.defineProperty(t,i,a),a};let ge=class extends ne{constructor(){super(),this.min=0,this.max=32,this.step=1,this.value=0,this.unit="A",this.disabled=!1,this.label="Charge Rate",this._sliderValue=0,this._dragging=!1,this._boundHandleSliderMove=this._handleSliderMove.bind(this),this._boundHandleSliderEnd=this._handleSliderEnd.bind(this)}updated(e){e.has("value")&&!this._dragging&&(this._sliderValue=this.value)}connectedCallback(){super.connectedCallback(),this._sliderValue=this.value}disconnectedCallback(){super.disconnectedCallback(),this._removeEventListeners()}get _percentage(){const e=this.max-this.min;return 0===e?0:(this._sliderValue-this.min)/e*100}_formatValue(e){return this.step<1?e.toFixed(1):e.toFixed(0)}_handleSliderStart(e){this.disabled||(this._dragging=!0,this._updateSliderValue(e),window.addEventListener("mousemove",this._boundHandleSliderMove),window.addEventListener("touchmove",this._boundHandleSliderMove),window.addEventListener("mouseup",this._boundHandleSliderEnd),window.addEventListener("touchend",this._boundHandleSliderEnd))}_handleSliderMove(e){this._dragging&&this._updateSliderValue(e)}_handleSliderEnd(){this._dragging&&(this._removeEventListeners(),this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:this._sliderValue},bubbles:!0,composed:!0})),setTimeout((()=>{this._dragging=!1}),100))}_removeEventListeners(){window.removeEventListener("mousemove",this._boundHandleSliderMove),window.removeEventListener("touchmove",this._boundHandleSliderMove),window.removeEventListener("mouseup",this._boundHandleSliderEnd),window.removeEventListener("touchend",this._boundHandleSliderEnd)}_updateSliderValue(e){const t=this.shadowRoot?.querySelector(".slider-wrapper");if(!t)return;const i=t.getBoundingClientRect();let s;s="touches"in e?e.touches[0].clientX:e.clientX;let n=(s-i.left)/i.width;n=Math.min(Math.max(n,0),1);let r=this.min+n*(this.max-this.min);r=Math.round(r/this.step)*this.step,r=Math.min(Math.max(r,this.min),this.max),this._sliderValue=Number(r.toFixed(2)),this.requestUpdate()}render(){return q`
  ...
  `,ve([de({type:Number})],ge.prototype,"min",void 0),ve([de({type:Number})],ge.prototype,"max",void 0),ve([de({type:Number})],ge.prototype,"step",void 0),ve([de({type:Number})],ge.prototype,"value",void 0),ve([de({type:String})],ge.prototype,"unit",void 0),ve([de({type:Boolean})],ge.prototype,"disabled",void 0),ve([de({type:String})],ge.prototype,"label",void 0),ve([ue()],ge.prototype,"_sliderValue",void 0),ve([ue()],ge.prototype,"_dragging",void 0),ve([function(e){return(t,i)=>{const s="function"==typeof t?t:t[i];Object.assign(s,e)}}({passive:!0})],ge.prototype,"_handleSliderStart",null),ge=ve([(e=>(t,i)=>{void 0!==i?i.addInitializer((()=>{customElements.define(e,t)})):customElements.define(e,t)})("evse-slider")],ge);customElements.define("limit-component",class extends ne{static get properties(){return{limit:{type:Object,attribute:!1},setLimit:{type:Object,attribute:!1},delLimit:{type:Object,attribute:!1},feat_battery:{type:Boolean},feat_soc:{type:Boolean},energy_max_value:{type:Number},range_max_value:{type:Number},range_unit:{type:String},_lang:{type:String}}}constructor(){super(),this.feat_soc=!1,this.feat_range=!1,this.energy_max_value=100,this.range_max_value=600,this.range_unit="km",this._lang="en",this._showLimitForm=!1,this._selectedLimitType="time",this._hours=0,this._minutes=0,this._value=0}static get styles(){return r`
      :host {
        display: block;
        width: 100%;
      }
    ...
    `}});var pe=function(e,t,i,s){for(var n,r=arguments.length,a=r<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s,o=e.length-1;o>=0;o--)(n=e[o])&&(a=(r<3?n(a):r>3?n(t,i,a):n(t,i))||a);return r>3&&a&&Object.defineProperty(t,i,a),a};class me extends ne{static get styles(){return ae}_wifiIcon(e){return e>=-65?"mdi:wifi-strength-4":-65>e&&e>=-70?"mdi:wifi-strength-3":-70>e&&e>=-75?"mdi:wifi-strength-2":-75>e&&e>=-80?"mdi:wifi-strength-1":"mdi:wifi-strength-alert-outline"}_handleIconClick(e){const t=this.config?.[e];this.showMoreInfoHandler&&"string"==typeof t&&t&&this.showMoreInfoHandler(t)}render(){if(!this.hass||!this.config)return q``;const e=Number(this.wifiSignalEntity?.state),t=this.statusEntity?.state,i=this.vehicleConnectedEntity?.state,s=this.chargingStatusEntity?.state;return q`
        ...
        `}}pe([de({attribute:!1})],me.prototype,"hass",void 0),pe([de({attribute:!1})],me.prototype,"config",void 0),pe([de({attribute:!1})],me.prototype,"wifiSignalEntity",void 0),pe([de({attribute:!1})],me.prototype,"statusEntity",void 0),pe([de({attribute:!1})],me.prototype,"vehicleConnectedEntity",void 0),pe([de({attribute:!1})],me.prototype,"chargingStatusEntity",void 0),pe([de({attribute:!1})],me.prototype,"showMoreInfoHandler",void 0),customElements.define("status-icons",me);var ye=function(e,t,i,s){for(var n,r=arguments.length,a=r<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s,o=e.length-1;o>=0;o--)(n=e[o])&&(a=(r<3?n(a):r>3?n(t,i,a):n(t,i))||a);return r>3&&a&&Object.defineProperty(t,i,a),a};class _e extends ne{static get styles(){return ae}render(){const e=this.chargingStatusEntity?.state,t=this.statusEntity?.state;return q`
            <div class="status-heading">
                <div class="status-badge ${"error"===e?"badge-error":"disabled"===t?"badge-disabled":"charging"===e?"badge-charging":"badge-active"}">
                    ${ce(e||"",this.language)}
                </div>
            </div>
        `}}ye([de({attribute:!1})],_e.prototype,"statusEntity",void 0),ye([de({attribute:!1})],_e.prototype,"chargingStatusEntity",void 0),ye([de({attribute:!1})],_e.prototype,"language",void 0),customElements.define("status-heading",_e);var be=function(e,t,i,s){for(var n,r=arguments.length,a=r<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s,o=e.length-1;o>=0;o--)(n=e[o])&&(a=(r<3?n(a):r>3?n(t,i,a):n(t,i))||a);return r>3&&a&&Object.defineProperty(t,i,a),a};class fe extends ne{constructor(){super(...arguments),this.localTimeElapsed=0}static get styles(){return ae}_handleItemClick(e){const t=this.config?.[e];this.showMoreInfoHandler&&"string"==typeof t&&t&&this.showMoreInfoHandler(t)}render(){return this.hass&&this.config&&this.convertTimeHandler?q`
            <div class="grid-container">
                ${this.powerEntity?q`
                        <div class="grid-item">
                            <div class="grid-item-label">${ce("power",this.language)}</div>
                            <div
                ...
                ${this.currentEntity?q`
                        <div class="grid-item">
                            <div class="grid-item-label">${ce("current",this.language)}</div>
                            <div
                                class="grid-item-value clickable"
                ...
                ${this.sessionEnergyEntity?q`
                        <div class="grid-item">
                            <div class="grid-item-label">${ce("session",this.language)}</div>
                            <div
                                class="grid-item-value clickable"
                ...
                ${this.timeElapsedEntity?q`
                        <div class="grid-item">
                            <div class="grid-item-label">${ce("elapsed",this.language)}</div>
        ...
        `:q``}}be([de({attribute:!1})],fe.prototype,"hass",void 0),be([de({attribute:!1})],fe.prototype,"config",void 0),be([de({attribute:!1})],fe.prototype,"powerEntity",void 0),be([de({attribute:!1})],fe.prototype,"currentEntity",void 0),be([de({attribute:!1})],fe.prototype,"sessionEnergyEntity",void 0),be([de({attribute:!1})],fe.prototype,"timeElapsedEntity",void 0),be([de({type:Number})],fe.prototype,"localTimeElapsed",void 0),be([de({type:String})],fe.prototype,"language",void 0),be([de({attribute:!1})],fe.prototype,"showMoreInfoHandler",void 0),be([de({attribute:!1})],fe.prototype,"convertTimeHandler",void 0),customElements.define("info-grid",fe);var we=function(e,t,i,s){for(var n,r=arguments.length,a=r<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s,o=e.length-1;o>=0;o--)(n=e[o])&&(a=(r<3?n(a):r>3?n(t,i,a):n(t,i))||a);return r>3&&a&&Object.defineProperty(t,i,a),a};class xe extends ne{static get styles(){return ae}render(){if(!this.config)return q``;const e=this.config.feat_soc&&this.vehicleBatteryLevelEntity,t=this.config.feat_range&&this.vehicleRangeEntity;return e||t?q`
            <div class="vehicle">
                ${e?q`
                    <progress-bar
        ...
        `:q``}}we([de({attribute:!1})],xe.prototype,"config",void 0),we([de({attribute:!1})],xe.prototype,"vehicleBatteryLevelEntity",void 0),we([de({attribute:!1})],xe.prototype,"vehicleRangeEntity",void 0),customElements.define("vehicle-info",xe);var $e=function(e,t,i,s){for(var n,r=arguments.length,a=r<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s,o=e.length-1;o>=0;o--)(n=e[o])&&(a=(r<3?n(a):r>3?n(t,i,a):n(t,i))||a);return r>3&&a&&Object.defineProperty(t,i,a),a};class Ee extends ne{static get styles(){return ae}_handleButtonClick(e){const t=this.config?.override_entity;this.selectOverrideStateHandler&&"string"==typeof t&&t&&this.selectOverrideStateHandler(t,e)}render(){if(!this.config||!this.overrideEntity)return q``;const e=this.overrideEntity?.state,t=this.chargingStatusEntity?.state;return q`
        ...
        `}}$e([de({attribute:!1})],Ee.prototype,"config",void 0),$e([de({attribute:!1})],Ee.prototype,"overrideEntity",void 0),$e([de({attribute:!1})],Ee.prototype,"chargingStatusEntity",void 0),$e([de({attribute:!1})],Ee.prototype,"selectOverrideStateHandler",void 0),customElements.define("override-controls",Ee);var Se=function(e,t,i,s){for(var n,r=arguments.length,a=r<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s,o=e.length-1;o>=0;o--)(n=e[o])&&(a=(r<3?n(a):r>3?n(t,i,a):n(t,i))||a);return r>3&&a&&Object.defineProperty(t,i,a),a};class ke extends ne{constructor(){super(...arguments),this.entities=[]}static get styles(){return ae}_handleEntityClick(e){this.showMoreInfoHandler&&e&&this.showMoreInfoHandler(e)}render(){return this.hass&&this.entities&&0!==this.entities.length?q`
    ...
    `}}),customElements.define("openevse-card-editor",class extends ne{static get properties(){return{hass:{type:Object},config:{type:Object},_lang:{type:String},_deviceIdChanged:{type:Boolean}}}static get styles(){return r`
      .form-container {
          display: flex;
          flex-direction: column;
      }
